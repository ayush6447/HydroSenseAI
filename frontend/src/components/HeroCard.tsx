...
export default function HeroCard() {
  return (
    <div className="bg-hero p-10 rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden group">
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-3 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20 w-fit mb-8">
          ...
          <span className="text-[10px] font-bold uppercase tracking-widest text-white/90">System Health: Green</span>
        </div>
