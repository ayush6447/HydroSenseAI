...
export default function YieldProbabilityCard({ value }: { value: number }) {
  return (
    <div className="bg-card/40 border border-card/80 p-8 rounded-[2.5rem] shadow-sm flex flex-col md:flex-row items-center gap-10">
      <div className="relative w-32 h-32 flex items-center justify-center">
        ...
        <svg className="w-full h-full transform -rotate-90">
          ...
          <circle
            ...
            strokeDashoffset={351.8 * (1 - (value || 0) / 100)}
      ...
      <div className="flex-1 space-y-4">
        ...
        <h4 className="text-3xl font-black text-text tracking-tight uppercase tracking-tight">Optimal Growth Trace</h4>
        <p className="text-sm font-medium text-muted leading-relaxed">
           System is performing within 2.3% of the ideal genetic potential for Genovese Basil. 
           Harvest window predicted in 8 days.
        </p>
      </div>
